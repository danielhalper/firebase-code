        ...
        <p className="section-p">Here is basic information for individuals needing to submit fingerprints to the DOJ for background checks.</p>
          <div className="bg-check-div-all-steps">
            <div className="bg-check-step-styling">
              ...
              <p className="bg-check-p">(or send a filled out form to the Live Scan site you are going to)</p>
              <p className="bg-check-p">Click on arrow on top right hand side of form to pop out new window and print</p>
              <p className="bg-check-p">Note: You do not need to fill out the Contact Telephone Number, OCA Number, Billing Number, or Misc. Number</p>
              <iframe className="bg-check-iframe" src="https://drive.google.com/file/d/1pl1KecIrttIxzhWrVOpeYIiX1FT-2FF6/preview" width="640" height="480" frameBorder="0" allow="autoplay"></iframe>
            </div>
            <div className="bg-check-step-styling">
              <div className="div-bg-check-number-and-title">
                <span className="bg-check-number-styling">2</span><h3 className="bg-check-step-title">Get Fingerprinted</h3>
              </div>
              <p className="bg-check-p">Once you have obtained the necessary forms from the applicant agency, go to a local Live Scan site to be fingerprinted. To find the site nearest to you and a listing of fees, see Public Live Scan Sites or click here. Select the county and type your neighborhood in the search. You can find the same list of counties at the end of this document.</p>
              <p className="bg-check-p">Please note: You must present valid photo identification when being fingerprinted. Expired identification information will not be accepted.</p>
              <p className="bg-check-p">A fingerprint-rolling fee may be collected when you get your fingerprints taken. Since this fee varies widely among locations, you will want to review the cost before going to a fingerprinting site. Be sure to check for any restrictions on method of payment, such as cash or money order only. The List of Applicant Live Scan Sites provides information by location on fees, hours of operation and if an appointment is needed.</p>
            ...
            <div className="bg-check-step-styling">
              ...
              <p className="bg-check-p">Once the submission is received and processed, the DOJ will respond to the applicant agency either electronically or via U.S. mail. Step Up Tutoring will be given the results and will let you know whether or not you have passed! This entire process will only take a couple days so you can start tutoring in no time!</p>
              <p className="bg-check-p">Please keep the paper and/or take a picture of the form. We can do a search by your date of birth and ATI number (written in by the Live Scan attendant) in case the results get lost or are delayed.</p>
            </div>
          </div>
      </div>
    )
