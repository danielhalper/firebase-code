      ...
      <div>
        ...
        <p className="section-p">Here is basic information for individuals needing to submit fingerprints to the DOJ for background checks.</p>
          <div className="bg-check-div-all-steps">
            ...
            <p className="bg-check-p"><small>For volunteers residing outside of California,</small> <strong><a href="https://docs.google.com/document/d/1OskeY1-JGEbTYRCMSLa5GYr8UdvNw8zN/edit" target='_blank'>please click here.</a> </strong></p>
            ...
            <p className="bg-check-p">Once you have obtained the necessary forms from the applicant agency, go to a local Live Scan site to be fingerprinted. To find the site nearest to you and a listing of fees, see <strong><a href="https://oag.ca.gov/fingerprints/locations" target='_blank'>Public Live Scan Sites</a></strong> or <strong><a href="https://docs.google.com/document/d/1M_ZBQeidwncFqY4vR3bPNKM30_dGhEl5AcojcwCvnVw/edit" target='_blank'>click here</a></strong>
              , or <strong><a href="https://www.google.com/search?sa=X&tbs=lf:1,lf_ui:2&tbm=lcl&sxsrf=AOaemvJBofUDn16eg2D94bwErT9nWqNUwg:1630567059485&q=livescan+near+me" target='_blank'>click here.</a></strong>  Select the county and type your neighborhood in the search. You can find the same list of counties at the end of this document.</p>
